...
const Input: React.FC<SchemaProp> = ({
  ...
  //
  return (
    <div key={props?.name} className="w-[100%] flex flex-col items-center">
      {validation?.isRequired ? (
        <>
          ...
          />
          <p
            className="w-[90%] text-[orangered] h-[1px] text-left"
        ...
        <>
          ...
          <input {...register(props?.name!)} {...props} id={props?.name} />
        </>
      )}
    </div>
  );
